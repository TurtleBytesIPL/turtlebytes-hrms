      ...
      try {
        ...
        await this.prisma.leaveBalance.createMany({
          data: [
            ...
            { employeeId: employee.id, year: currentYear, leaveType: LeaveType.MATERNITY, allocated: 90 },
            { employeeId: employee.id, year: currentYear, leaveType: LeaveType.PATERNITY, allocated: 15 },
          ],
        });
